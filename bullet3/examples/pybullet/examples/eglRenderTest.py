...
cv2.resizeWindow("rgb",pixelWidth,pixelHeight)
while (p.isConnected()):
  for yaw in range(0, 360, 10):
    ...
    color_img_ =np.reshape(img_arr[2], (pixelHeight, pixelWidth, 4))[:,:,0:3]
    color_img =cv2.cvtColor(color_img_[:,:,0:3], cv2.COLOR_BGR2RGB)
